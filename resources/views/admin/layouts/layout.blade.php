    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <form class="form-inline ml-3" method="get" action="{{ route('admin.search') }}">
            <div class="input-group input-group-sm">
                <input name="s" class="form-control form-control-navbar" type="search" placeholder="Найти публикацию" aria-label="Поиск" required>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" target="_blank" class="brand-link">
            <img src="{{ asset('assets/admin/img/AdminLTELogo.png') }}"
                 ...
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Investmedia</span>
        </a>
...
<script src="{{ asset('assets/admin/ckeditor5/build/ckeditor.js') }}">
</script>
<script src="{{ asset('assets/admin/ckfinder/ckfinder.js') }}">
</script>
<script type="text/javascript">

    //чтобы включить браузер файлов, заходим в ckfinder, config.php и редачим там
    ClassicEditor
        .create(document.querySelector('#content'), {
            alignment: {
                options: ['left', 'right', 'center']
            }, //https://ckeditor.com/docs/ckeditor5/latest/features/text-alignment.html
            ckfinder: {
