                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tags[]" id="tags" class="select2" multiple="multiple"
                                        ...
                                        @endforeach {{-- all() преобразует объект в массив --}}
                                        {{-- Если в массиве tags есть ключ k, то выделяем его тоже --}}
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                   ...
                                   {{-- @if ($post->thumbnail)
                                    ...
                                    @else
                                        <div><img src="{{asset('no-image.jpg')}}" alt="" class="img-thumbnail mt-2" width="200"></div>
                                    @endif--}}
                                </div>
